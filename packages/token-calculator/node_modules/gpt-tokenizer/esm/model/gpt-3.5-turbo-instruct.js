...
// prettier-ignore
const api = GptEncoding.getEncodingApiForModel('gpt-3.5-turbo-instruct', () => bpeRanks, { name: "gpt-3.5-turbo-instruct", slug: "gpt-3-5-turbo-instruct", performance: 1, latency: 2, modalities: { input: ["text"], output: ["text"] }, context_window: 4096, max_output_tokens: 4096, knowledge_cutoff: new Date(1630454400000), supported_features: ["fine_tuning"], supported_endpoints: ["chat_completions", "responses"], reasoning_tokens: false, price_data: { main: { input: 1.5, output: 2 } } });
