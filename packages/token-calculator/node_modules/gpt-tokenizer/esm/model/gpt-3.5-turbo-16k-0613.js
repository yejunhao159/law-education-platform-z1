...
// prettier-ignore
const api = GptEncoding.getEncodingApiForModel('gpt-3.5-turbo-16k-0613', () => bpeRanks, { name: "gpt-3.5-turbo-16k-0613", slug: "gpt-3-5-turbo-16k-0613", performance: 1, latency: 2, modalities: { input: ["text"], output: ["text"] }, context_window: 16385, max_output_tokens: 4096, knowledge_cutoff: new Date(1630454400000), supported_features: ["fine_tuning"], supported_endpoints: ["chat_completions", "responses", "batch"], reasoning_tokens: false, price_data: { main: { input: 3, output: 4 }, batch: { input: 1.5, output: 2 } } });
