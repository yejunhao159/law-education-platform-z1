...
// prettier-ignore
const api = GptEncoding_js_1.GptEncoding.getEncodingApiForModel('o3-mini-2025-01-31', () => o200k_base_js_1.default, { name: "o3-mini-2025-01-31", slug: "o3-mini-2025-01-31", performance: 4, latency: 3, modalities: { input: ["text"], output: ["text"] }, context_window: 200000, max_output_tokens: 100000, knowledge_cutoff: new Date(1696118400000), supported_features: ["streaming", "structured_outputs", "function_calling", "file_search", "file_uploads"], supported_endpoints: ["chat_completions", "responses", "assistants", "batch"], reasoning_tokens: true });
