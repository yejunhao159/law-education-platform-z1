...
// prettier-ignore
const api = GptEncoding_js_1.GptEncoding.getEncodingApiForModel('gpt-4-32k', () => cl100k_base_js_1.default, { name: "gpt-4-32k", slug: "gpt-4-32k", performance: 2, latency: 3, modalities: { input: ["text"], output: ["text"] }, context_window: 32768, max_output_tokens: 8192, knowledge_cutoff: new Date(1701388800000), supported_features: ["fine_tuning", "streaming"], supported_endpoints: ["chat_completions", "responses", "assistants"], reasoning_tokens: false, price_data: { main: { input: 60, output: 120 }, batch: { input: 30, output: 60 } } });
