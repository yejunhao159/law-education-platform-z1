...
// prettier-ignore
const api = GptEncoding_js_1.GptEncoding.getEncodingApiForModel('computer-use-preview', () => o200k_base_js_1.default, { name: "computer-use-preview-2025-03-11", slug: "computer-use-preview-2025-03-11", performance: 2, latency: 2, modalities: { input: ["text", "image"], output: ["text"] }, context_window: 8192, max_output_tokens: 1024, knowledge_cutoff: new Date(1696118400000), supported_features: ["function_calling"], supported_endpoints: ["responses", "batch"], reasoning_tokens: true, price_data: { main: { input: 3, output: 12 }, batch: { input: 1.5, output: 6 } } });
