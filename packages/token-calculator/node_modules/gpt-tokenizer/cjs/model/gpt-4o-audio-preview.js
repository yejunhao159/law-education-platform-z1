...
// prettier-ignore
const api = GptEncoding_js_1.GptEncoding.getEncodingApiForModel('gpt-4o-audio-preview', () => o200k_base_js_1.default, { name: "gpt-4o-audio-preview-2024-12-17", slug: "gpt-4o-audio-preview-2024-12-17", performance: 3, latency: 3, modalities: { input: ["text", "audio"], output: ["text", "audio"] }, context_window: 128000, max_output_tokens: 16384, knowledge_cutoff: new Date(1696118400000), supported_features: ["streaming", "function_calling"], supported_endpoints: ["chat_completions"], reasoning_tokens: false, price_data: { main: { input: 10, output: 30 }, batch: { input: 5, output: 15 } } });
