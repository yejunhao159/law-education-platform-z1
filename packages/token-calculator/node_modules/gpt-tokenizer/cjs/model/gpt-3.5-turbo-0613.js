...
// prettier-ignore
const api = GptEncoding_js_1.GptEncoding.getEncodingApiForModel('gpt-3.5-turbo-0613', () => cl100k_base_js_1.default, { name: "gpt-3.5-turbo-0613", slug: "gpt-3-5-turbo-0613", performance: 1, latency: 2, modalities: { input: ["text"], output: ["text"] }, context_window: 16385, max_output_tokens: 4096, knowledge_cutoff: new Date(1630454400000), supported_features: ["fine_tuning"], supported_endpoints: ["chat_completions", "responses", "batch"], reasoning_tokens: false, price_data: { main: { input: 1.5, output: 2 }, batch: { input: .75, output: 1 } } });
