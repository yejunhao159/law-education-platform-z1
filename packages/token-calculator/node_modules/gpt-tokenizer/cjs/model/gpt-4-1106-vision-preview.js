...
// prettier-ignore
const api = GptEncoding_js_1.GptEncoding.getEncodingApiForModel('gpt-4-1106-vision-preview', () => cl100k_base_js_1.default, { name: "gpt-4-1106-vision-preview", slug: "gpt-4-1106-vision-preview", performance: 2, latency: 3, deprecated: true, modalities: { input: ["text", "image"], output: ["text"] }, context_window: 128000, max_output_tokens: 4096, knowledge_cutoff: new Date(1701388800000), supported_features: ["fine_tuning", "streaming"], supported_endpoints: ["chat_completions", "responses", "assistants"], reasoning_tokens: false, price_data: { main: { input: 10, output: 30 }, batch: { input: 5, output: 15 } } });
