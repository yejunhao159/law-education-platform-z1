...
import { 
// 新的依赖注入方式
ConversationStorage, BetterSQLite3Adapter, 
// 向后兼容方式
initializeConversationStorage, } from '../src/index.js';
    ...
    class MockDatabaseAdapter {
        ...
        prepare(sql) {
            return {
                ...
                get: (...params) => this.mockData.get('test') || null,
                all: (...params) => [],
                finalize: () => { }
            };
        }
...
//# sourceMappingURL=migration-example.js.map