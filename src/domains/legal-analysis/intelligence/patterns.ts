...
/**
 * 法律关系模式
 * 从 lib/legal-analysis-engine.ts 整合的系统化法律关系识别模式
 */
export const LEGAL_RELATION_PATTERNS = {
  // 借贷关系
  LOAN_RELATION: {
    keywords: ['借款', '贷款', '借贷', '还款', '欠款', '债务', '债权'],
    relation: '借贷关系'
  },

  // 合同关系
  CONTRACT_RELATION: {
    keywords: ['合同', '协议', '签订', '履行', '约定', '条款'],
    relation: '合同关系'
  },

  // 买卖关系
  SALE_RELATION: {
    keywords: ['买卖', '购买', '销售', '交付', '货物', '商品'],
    relation: '买卖关系'
  },

  // 租赁关系
  LEASE_RELATION: {
    keywords: ['租赁', '出租', '承租', '租金', '租期', '房屋租赁'],
    relation: '租赁关系'
  },

  // 侵权关系
  TORT_RELATION: {
    keywords: ['侵权', '损害', '赔偿', '侵害', '责任', '过错'],
    relation: '侵权关系'
  },

  // 劳动关系
  LABOR_RELATION: {
    keywords: ['劳动', '用工', '工资', '解除', '员工', '雇佣'],
    relation: '劳动关系'
  },

  // 担保关系
  GUARANTEE_RELATION: {
    keywords: ['保证', '担保', '抵押', '质押', '担保人', '保证金'],
    relation: '担保关系'
  },

  // 委托代理关系
  AGENCY_RELATION: {
    keywords: ['委托', '代理', '授权', '委托人', '代理人'],
    relation: '委托代理关系'
  },

  // 赠与关系
  GIFT_RELATION: {
    keywords: ['赠与', '捐赠', '无偿', '赠送'],
    relation: '赠与关系'
  },

  // 继承关系
  INHERITANCE_RELATION: {
    keywords: ['继承', '遗产', '遗嘱', '法定继承', '遗嘱继承'],
    relation: '继承关系'
  }
}
